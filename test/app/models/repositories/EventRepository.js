...
module.exports = {
    ...
    testEventRepository_Exists: function(test) {
        // Assert
        test.notEqual(EventRepository, null);
        test.notEqual(EventRepository, undefined);
        test.done();
    },
    testGetEvents_GetsEvents: function(test) {
        // Assert
    ...
    testGetEvents_ThrowsExceptionIfEntityFails: function(test) {
        // Arrange
    ...
    testGetEventById_GetsEvent: function(test) {
        // Arrange
    ...
    testGetEventById_ThrowsExceptionIfNoEventIdGiven: function(test) {
        // Act
    ...
    testGetEventById_ThrowsExceptionIfEntityFails: function(test) {
        // Arrange
        EventMock.mockReturnError("Entity Failed");
    ...
    testCreateEvent_CreatesEvent: function(test) {
        // Arrange
        EventMock.mockReturnError("Entity Failed");
